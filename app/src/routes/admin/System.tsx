  ...
  return (
    ...
    >
      ...
      <ParagraphItem>
        ...
        <JSONEditorProvider
          value={data.pwamanifest ?? ""}
          onChange={(value) =>
            dispatch({ type: "update:general.pwamanifest", value })
          }
        >
      ...
      <ParagraphItem>
        ...
        <Switch
          ...
          onCheckedChange={(value) => {
            dispatch({ type: "update:general.debugmode", value });
          }}
        />
      </ParagraphItem>
      <ParagraphSpace />
...
function Mail({ data, dispatch, onChange }: CompProps<MailState>) {
  ...
  const whitelist = useMemo(() => {
    const raw = data.whitelist.custom
      .split(",")
      .map((item) => item.trim())
  ...
  return (
    ...
    >
      ...
      <ParagraphItem>
        ...
        <Switch
          checked={data.whitelist.enabled}
          onCheckedChange={(value) => {
            dispatch({
              type: "update:mail.whitelist.enabled",
              value,
            });
          }}
        />
      ...
      <ParagraphItem>
        ...
        <MultiCombobox
          value={data.whitelist.whitelist}
          list={whitelist}
          disabled={!data.whitelist.enabled}
          onChange={(value) => {
            dispatch({
              type: "update:mail.whitelist.whitelist",
              value,
            });
          }}
          placeholder={t("admin.system.mailWhitelistSelected", {
            length: data.whitelist.whitelist.length,
          })}
      ...
      <Input
        className={`mb-2`}
        value={data.whitelist.custom}
        onChange={(e) =>
          dispatch({
            type: "update:mail.whitelist.custom",
            value: e.target.value,
          })
        }
        disabled={!data.whitelist.enabled}
  ...
  return (
    ...
    >
      <ParagraphItem>
        ...
        <Switch
          checked={data.closeregister}
          onCheckedChange={(value) => {
            dispatch({ type: "update:site.closeregister", value });
          }}
        />
      </ParagraphItem>
      <ParagraphItem>
        ...
        <Switch
          checked={data.closerelay}
          onCheckedChange={(value) => {
            dispatch({ type: "update:site.closerelay", value });
          }}
        />
      </ParagraphItem>
      <ParagraphItem>
        ...
        <Switch
          checked={data.relayplan}
          onCheckedChange={(value) => {
            dispatch({ type: "update:site.relayplan", value });
          }}
        />
      </ParagraphItem>
      <ParagraphItem>
      ...
      <ParagraphItem>
        ...
        <Switch
          checked={data.authfooter}
          onCheckedChange={(value) => {
            dispatch({ type: "update:site.authfooter", value });
          }}
        />
      </ParagraphItem>
      <ParagraphFooter>
...
function Common({ form, data, dispatch, onChange }: CompProps<CommonState>) {
  ...
  return (
    ...
    >
      <ParagraphItem>
        <Label className={`flex flex-row items-center`}>
          {t("admin.system.imagestore")}
          <Tips content={t("admin.system.imagestoreTip")} />
        </Label>
        <Switch
          checked={data.imagestore}
          onCheckedChange={(value) => {
            dispatch({ type: "update:common.imagestore", value });
          }}
        />
      </ParagraphItem>
      {data.imagestore && form.general.backend.length === 0 && (
        <ParagraphDescription border={true}>
          {t("admin.system.imagestoreNoBackend")}
        </ParagraphDescription>
      )}
      <ParagraphSpace />
      <ParagraphItem>
  ...
  return (
    ...
    >
      ...
      <ParagraphItem>
        ...
        <Switch
          checked={data.imageproxy}
          onCheckedChange={(value) => {
            dispatch({ type: "update:search.imageproxy", value });
          }}
        />
      </ParagraphItem>
      <ParagraphItem>
      ...
      <ParagraphItem>
        ...
        <NumberInput
          value={data.croplen}
          onValueChange={(value) =>
            dispatch({ type: "update:search.croplen", value })
          }
          min={1}
          disabled={!data.crop}
        />
      ...
      <ParagraphItem>
        ...
        <Combobox
          value={["none", "moderation", "strict"][data.safesearch] || "none"}
          onChange={(value) => {
            dispatch({
              type: "update:search.safesearch",
