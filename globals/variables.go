...
const PaymentQuotaRatio = 10.0

var PaymentEpay = EpayConfig{}
...
func SetVisionModels(models []string) {
	if len(models) == 0 {
		VisionModels = append([]string(nil), defaultVisionModels...)
		return
	}

	VisionModels = append([]string(nil), models...)
}
